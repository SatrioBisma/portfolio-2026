...
interface ProjectPerikuProps {
  slug?: string
}

export function ProjectPeriku({ slug }: ProjectPerikuProps) {
  return (
    <motion.a
      key="periku"
      layout
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <p className="mt-2 text-sm font-light leading-relaxed text-muted-foreground">
          An integrated IoT mobile dashboard developed to provide real-time monitoring and data insights for precision agriculture management.
        </p>

        <div className="mt-4 flex flex-wrap gap-2">
          {["Java", "Express.js"].map((tag) => (
            <span
              key={tag}
