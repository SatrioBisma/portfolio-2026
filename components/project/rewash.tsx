...
interface ProjectRewashProps {
  slug?: string
}

export function ProjectRewash({ slug }: ProjectRewashProps) {
  return (
    <motion.a
      key="rewash"
      layout
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <p className="mt-2 text-sm font-light leading-relaxed text-muted-foreground">
          A mobile-first laundry service locator and booking platform designed to connect users with nearby laundry providers seamlessly.
        </p>

        <div className="mt-4 flex flex-wrap gap-2">
          {["Java", "Android Studio"].map((tag) => (
            <span
              key={tag}
